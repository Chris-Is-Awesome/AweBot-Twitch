module.exports = {
	...
	Bff: function (client, channel, tags) {
		const friendsPerGame = {
			...
			"the Mario series": [ "Mario", "Luigi", "Bowser", "Princess Peach", "Princess Daisy", "Toad", "Toadsworth", "Yoshi", "King Boo", "Rosalina", "Bowser Jr.", "Pauline", "Toadette", "Captain Toad", "Wario", "Kamek", "Waluigi", "Donkey Kong", "Diddy Kong", "Birdo", "Nabbit" ],
		...
		if (game == "The Legend of Zelda: Twilight Princess" && friend == "Howard") {
			client.say(channel, tags['display-name'] + " Your new best friend is -- me?! W-Why this is such an honor to be appreciated so much! ❤️");
		}
		else {
			client.say(channel, tags['display-name'] + " Your new best friend is " + friend + " from " + game + "! " + endSentence);
		}
	}
}